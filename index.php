            ...
            <form class="forms" action="contrato.php" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select mr-sm-2" name="nacionalidad-beneficiario" id="nacionalidad">
                            <option selected>Elegir respuesta...</option>
                            <option value="Mexicano">Mexicano</option>
                            <option value="Mexicana">Mexicana</option>
                            <option value="Extranjero">Extranjero</option>
                    ...
                    <div class="form-group col-md-6">
                        <label for="nacimiento-beneficiario">Lugar De Nacimiento:</label>
                        <input type="text" class="form-control" name="nacimiento-beneficiario"
                            id="nacimiento-beneficiario" placeholder="Monterrey, Nuevo León" minlength="4"
                            maxlength="14" size="10">
                    </div>
                </div>
                <div class="form-group">
                    <label for="home-beneficiario">Domicilio (Incluyendo C.P.):</label>
                    <input type="text" class="form-control" name="home-beneficiario" id="home-beneficiario"
